...
namespace E2C.ChartGraphic
{
    public class E2ChartGraphicLineChartLine : E2ChartGraphic
    {
            ...
            if (curve)
            {
                if (inverted)
                {
                    ...
                    for (int i = m_start + 1; i <= m_end; ++i)
                    {
                        ...
                        CreateBerzierCurve(p0, p1, t0, t1, colors[colorIndex]);
                    }
                }
                else
                {
            ...
            else
            {
                if (inverted)
                {
                    ...
                    for (int i = m_start + 1; i <= m_end; ++i)
                    {
                        ...
                        AddPolygonRectRight(pLast, points, colors[colorIndex]);
                    }
                }
                else
                {
        ...
        protected void CreateBerzierCurve(Vector2 p0, Vector2 p1, Vector2 t0, Vector2 t1, Color c)
        {
