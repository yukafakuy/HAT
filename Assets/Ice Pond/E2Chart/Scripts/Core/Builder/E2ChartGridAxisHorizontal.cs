...
namespace E2C.ChartBuilder
{
    public class HorizontalAxis : E2ChartGridAxis
    {
        ...
        public override void CreateLabels()
        {
            ...
            //create labels
            float widthLimit = axisOptions.labelAreaSize > 0 ? axisOptions.labelAreaSize : 
                (gridRect.rect.height - titleHeight - tickSize.y - lineWidth * 0.5f - axisOptions.labelTextOption.fontSize) * AXIS_LABEL_AREA_LIMIT;
            ...
            if (axisOptions.labelAreaSize > 0) maxWidth = axisOptions.labelAreaSize;
