...
namespace E2C.ChartBuilder
{
    public class RectGrid : E2ChartGrid
    {
        ...
        public override void InitGrid()
        {
            ...
            if (cBuilder.thresholdLine != null)
            {
                if (cBuilder.thresholdLine.axis == E2ChartOptions.AxisDirection.X) xAxis.thresholdLines = cBuilder.thresholdLine;
                if (cBuilder.thresholdLine.axis == E2ChartOptions.AxisDirection.Y) yAxis.thresholdLines = cBuilder.thresholdLine;
            }
        ...
        public override void UpdateGrid()
        {
            ...
            if (yAxis.thresholdLines != null) yAxis.CreateThresholdLines();
            if (xAxis.thresholdLines != null) xAxis.CreateThresholdLines();
