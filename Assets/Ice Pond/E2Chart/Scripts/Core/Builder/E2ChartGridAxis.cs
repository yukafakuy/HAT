...
namespace E2C.ChartBuilder
{
    public abstract class E2ChartGridAxis
    {
        ...
        public E2ChartThresholdLines thresholdLines;
        ...
        public RectTransform gridRect { get => grid.gridRect; }
        public E2ChartTextFont generalFont { get => grid.options.plotOptions.generalFont; }
        ...
        public virtual void CreateThresholdLines() { }
