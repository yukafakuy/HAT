...
namespace E2C.ChartBuilder
{
    public static class E2ChartBuilderUtility
    {
        ...
        public static E2ChartBuilder GetChartBuilder(E2Chart chart, RectTransform rect = null)
        {
            ...
            switch (chart.chartType)
            {
                ...
                case E2Chart.ChartType.Gauge:
                    ...
                    break;
                case E2Chart.ChartType.AreaChart:
                    cBuilder = new AreaChartBuilder(chart, rect);
                    break;
                case E2Chart.ChartType.Table:
                    cBuilder = new TableBuilder(chart, rect);
                    break;
                case E2Chart.ChartType.Heatmap:
                    cBuilder = new HeatmapBuilder(chart, rect);
                    break;
                default: break;
            }
            return cBuilder;
        ...
        {
            return chart.chartType == E2Chart.ChartType.BarChart || chart.chartType == E2Chart.ChartType.LineChart || chart.chartType == E2Chart.ChartType.AreaChart;
        }
