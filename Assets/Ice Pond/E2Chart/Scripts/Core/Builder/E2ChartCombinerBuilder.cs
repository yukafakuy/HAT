    ...
    public class E2ChartCombinerBuilder
    {
        ...
        public void Build()
        {
            ...
            foreach (E2Chart chart in charts)
            {
                ...
                if (chart.chartOptions != null && chart.chartOptions.plotOptions.mouseTracking != E2ChartOptions.MouseTracking.None) chart.chartOptions.plotOptions.mouseTracking = combiner.mouseTracking;
                ...
                cBuilder.Init();
                cBuilder.Build();
                cBuilder.onBuildEnd += UpdateCharts;
        ...
        void UpdateCharts()
        {
            if (pointerHandler == null && combiner.mouseTracking != E2ChartOptions.MouseTracking.None)
            {
