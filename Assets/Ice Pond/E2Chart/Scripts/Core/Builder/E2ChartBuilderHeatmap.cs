...
{
    public class HeatmapBuilder : E2ChartBuilder
    {
        Image highlight;
        E2ChartGraphicHeatmap heatmap;

        public HeatmapBuilder(E2Chart c) : base(c) { }

        public HeatmapBuilder(E2Chart c, RectTransform rect) : base(c, rect) { }
        ...
        protected override void CreateItems()
        {
            ...
            //data values
            heatmap = E2ChartBuilderUtility.CreateEmptyRect("Heatmap", dataRect, true).gameObject.AddComponent<E2ChartGraphicHeatmap>();
            heatmap.dataValue = dataInfo.dataValue;
            heatmap.show = dataInfo.dataShow;
            heatmap.activeDataCount = dataInfo.activeDataCount;
            heatmap.colors = options.chartStyles.heatmap.colors;
            heatmap.spacing = options.chartStyles.heatmap.spacing;
            heatmap.activeSeriesCount = dataInfo.activeSeriesCount;
            heatmap.maxDataCount = dataInfo.maxDataCount;
        }
