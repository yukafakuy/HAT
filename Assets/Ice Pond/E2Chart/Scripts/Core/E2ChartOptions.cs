...
namespace E2C
{
    public class E2ChartOptions : MonoBehaviour
    {
        ...
        public struct HeatmapColor
        {
            ...
            public static Color GetColor(HeatmapColor a, HeatmapColor b, float value)
            {
                float t = Mathf.InverseLerp(a.value, b.value, value);
                Color c = new Color();
                c.r = Mathf.Lerp(a.color.r, b.color.r, t);
                c.g = Mathf.Lerp(a.color.g, b.color.g, t);
                c.b = Mathf.Lerp(a.color.b, b.color.b, t);
                c.a = Mathf.Lerp(a.color.a, b.color.a, t);
                return c;
            }
        }
        ...
        public class BarChartOptions
        {
            ...
            [Tooltip("Enable/disable category background")]
            public bool enableCategoryBackground = false;
            [Tooltip("Width of category background")]
            public float categoryBackgroundWidth = 30.0f;
            [Tooltip("Color of category background")]
            public Color categoryBackgroundColor = new Color(0.8f, 0.8f, 0.8f, 0.2f);
        ...
        {
            [Range(0.0f, 1.0f)] public float areaOpacity = 1.0f;
            [Tooltip("Enable/disable lines")]
        ...
        public class HeatmapOptions
        {
            ...
            [Tooltip("Values that corresponding to colors")]
            public HeatmapColor[] colors;
            //[Tooltip("Mix heatmap colors and series colors.")]
        ...
        public class ChartStyles
        {
            ...
            public AreaChartOptions areaChart = new AreaChartOptions();
            ...
            public HeatmapOptions heatmap = new HeatmapOptions();
        }
        ...
        public class PlotOptions
        {
            ...
            [Tooltip("Interval for each color when color mode is set to 'ByData'. Default interval for each color is 1.")]
            public int[] colorInterval = null;
        ...
        public class Axis
        {
            ...
            [Tooltip("Area that labels can occupy. Set -1 to let system decide the area size.")]
            public float labelAreaSize = -1;
        ...
        public class Label
        {
            ...
            [Tooltip("The interval of labels.")]
            public int interval = 1;
        }
...
#else
            try { plotOptions.generalFont = Resources.GetBuiltinResource<Font>("Arial.ttf"); }
            catch { plotOptions.generalFont = Resources.GetBuiltinResource<Font>("LegacyRuntime.ttf"); }
#endif
