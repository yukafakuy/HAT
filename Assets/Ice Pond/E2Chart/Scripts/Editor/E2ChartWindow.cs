...
namespace E2C.ChartEditor
{
    public class E2ChartWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("Preview active charts")) PreviewActiveCharts();
            if (GUILayout.Button("Preview all charts")) PreviewAllCharts();
            ...
            ShowChartTypeFilter();
            if (GUILayout.Button("Load presets for active charts") && presets.Length > 0) LoadPresetForActiveCharts();
            if (GUILayout.Button("Load presets for all charts") && presets.Length > 0) LoadPresetForAllCharts();

            EditorGUILayout.EndScrollView();
        }

        void ShowChartTypeFilter()
        {
        ...
        void LoadPresetForActiveCharts()
        {
        ...
        static void PreviewActiveCharts()
        {
            E2Chart[] charts = FindObjectsOfType<E2Chart>();
            foreach (E2Chart chart in charts)
            {
